...
if (12 % $setting['products_per_row']) {
	if ($setting['products_per_row'] == 3) {
		$lg_col = 4;
	}
	elseif ($setting['products_per_row'] == 5) {
		$lg_col = '2-4';
	}
	if ($setting['products_per_row'] == 1) {
		$lg_col = 12;
	}
} else {
...
<div class="col-lg-<?php echo $lg_col; ?> col-md-4 col-sm-6 col-xs-12 <?php echo $kuler->getSkinOption('enable_swap_image') ? '' : 'no-swap'; ?>">
	<div class="wrapper">
