<?php echo $header; ?>
<?php if ($attention) { ?>
<div class="container"><div class="attention"><?php echo $attention; ?><img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div></div>
<?php } ?>
<?php if ($success) { ?>
<div class="container"><div class="success"><?php echo $success; ?><img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div></div>
<?php } ?>
<?php if ($error_warning) { ?>
<div class="container"> <div class="warning"><?php echo $error_warning; ?><img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div> </div>
<?php } ?>
...
<div class="container">
  <div class="row">
    ...
    <div id="content" class="<?php echo $class; ?>">
      ...
      <div class="buttons">
        <div class="center">
	        <a href="<?php echo $continue; ?>" class="button check"><?php echo $button_shopping; ?></a>
	        <a href="<?php echo $checkout; ?>" class="button view"><?php echo $button_checkout; ?></a>
        </div>
      </div>
