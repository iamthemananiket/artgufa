  ...
  <div class="product-info">
    <div>
      ...
      <?php if ($review_status) { ?>
        <div class="review">
          <div>
            <img src="catalog/view/theme/<?php echo $kuler->getTheme() ?>/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />
    ...
    <div class="related-products">
      ...
      <div class="product-grid">
        <?php foreach ($products as $product) { ?>
          <div class="col-md-4 <?php echo $kuler->getSkinOption('enable_swap_image') ? '' : 'no-swap'; ?>">
