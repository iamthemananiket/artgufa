...
<?php if ($kuler->getRootSkin() == 'skin1') { ?>
  <?php include('_header_skin1.tpl'); ?>
<?php } elseif ($kuler->getRootSkin() == 'skin2'){ ?>
  <?php include('_header_skin2.tpl'); ?>
<?php } elseif ($kuler->getRootSkin() == 'skin3'||$kuler->getRootSkin() == 'skin4'){ ?>
  <?php include('_header_skin3.tpl'); ?>
<?php } elseif ($kuler->getRootSkin() == 'skin5'||$kuler->getRootSkin() == 'skin6'){ ?>
	<?php include('_header_skin4.tpl'); ?>
<?php } ?>