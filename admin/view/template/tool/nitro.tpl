...
<div id="content">
  ...
  <div class="box">
    <div class="box-heading">
      <h1><i class="icon-plane"></i> <?php echo 'Accelerate - Complete Web Performance Optimization Framework';//$heading_title; ?></h1>
    </div>
          ...
          <ul class="nav nav-tabs mainMenuTabs">
            ...
            <!--<li class="dropdown">
               ...
               <ul class="dropdown-menu">
                    ...
                    <li><a href="#cdn-rackspace" data-toggle="tab">Racksapce CDN</a></li>               
                    <li class="divider"></li>
            ...
            <div id="pane1" class="tab-pane active googlePageReportWidget">
				<div class="row-fluid">
                	...
                	<!--<div class="span4">
                        ...
                        <div class="box-content premium-widget" style="min-height:200px;">
                        <?php require(DIR_APPLICATION.'view/template/tool/nitro/premiumservices_widget.php'); ?>                        
                        </div>
                    </div>-->
                </div>
