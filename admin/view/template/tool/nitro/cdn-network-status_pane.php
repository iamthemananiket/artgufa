<div class="row-fluid">
  <div class="span8">
    ...
    <table class="form amazonstatustable">
      <tbody>
        <tr url="<?php echo(!empty($data['Nitro']['CDNAmazon']['HttpUrl'])) ? $data['Nitro']['CDNAmazon']['HttpUrl'] : ''?>">
          <td class="statusName">Amazon CloudFront/S3 CDN HTTP URL<div class="pingURL"></div></td>
          <td class="statusTime">13 ms response time</td>
          <td class="statusConnected">Connected</td>
        </tr>
        <tr url="<?php echo(!empty($data['Nitro']['CDNAmazon']['HttpsUrl'])) ? $data['Nitro']['CDNAmazon']['HttpsUrl'] : ''?>">
          <td class="statusName">Amazon CloudFront/S3 CDN HTTPS URL<div class="pingURL"></div></td>
          <td class="statusTime">13 ms response time</td>
          <td class="statusConnected">Connected</td>
        </tr>
      </tbody>
