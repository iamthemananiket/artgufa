...
$('.premiumServicesMenuItem,.moduleSpecificServicesMenuItem').click(function() {
	$('#modulespecific iframe').attr('src','http://isenselabs.com/external/premiumservices/?pid=12658&info=true');
});
$('.allServicesMenuItem,.premiumServicesMenuItem').click(function() {
	$('#allservices iframe').attr('src','http://isenselabs.com/external/premiumservices/?pid=12658&info=true&othersfirst=true');
});
</script>
